(function () {
    ...
    ui.Pages.define("/alithefox/aliwuyu/pages/split/split.html", {
        ...
        ready: function (element, options) {
            ...
            if (this._isSingleColumn()) {
                ...
                if (nav.canGoBack && nav.history.backStack[nav.history.backStack.length - 1].location === "/alithefox/aliwuyu/pages/split/split.html") {
            ...
            if (this._isSingleColumn()) {
                ...
                if (this._itemSelectionIndex >= 0) {
                    ...
                    nav.history.backStack.push({
                        location: "/alithefox/aliwuyu/pages/split/split.html",
            ...
            listView.selection.getItems().done(function updateDetails(items) {
                if (items.length > 0) {
                    ...
                    if (this._isSingleColumn()) {
                        // 如果使用对齐或纵向视图，则导航到包含
                        // 选定项详细信息的新页面。
                        nav.navigate("/alithefox/aliwuyu/pages/split/split.html", { groupKey: this._group.key, selectedIndex: this._itemSelectionIndex });
                    } else {
